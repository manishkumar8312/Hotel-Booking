  ...
  return (
    <div className="pt-20">
      <div className="max-w-6xl mx-auto w-full text-gray-800">
        ...
        {/* Loading State */}
        {loading && <p className="mt-6 text-center text-gray-500">Loading your bookings...</p>}

        {/* Error State */}
        {error && <p className="mt-6 text-center text-red-500">Error: {error}</p>}

        {/* Empty State */}
        {!loading && !error && bookings.length === 0 && (
          <p className="mt-6 text-center text-gray-500">You have no bookings yet.</p>
        )}
